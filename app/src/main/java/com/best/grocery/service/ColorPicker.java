...
import com.best.grocery.adapter.ColorViewAdapter;
import com.best.grocery.dialog.CustomDialogColor;
import com.best.grocery.entity.ColorPal;
...
import static com.best.grocery.utils.ColorUtils.dip2px;
import static com.best.grocery.utils.ColorUtils.getDimensionDp;
...
public class ColorPicker {
    ...
    public ColorPicker(Activity context) {
        dialogViewLayout = LayoutInflater.from(context).inflate(R.layout.dialog_color_palette_layout, null, false);
        ...
        this.negativeText = context.getString(R.string.abc_cancel);
        this.positiveText = context.getString(R.string.abc_got_it);
    ...
    public void show() {
        ...
        mDialog = new WeakReference<>(new CustomDialogColor(context, dialogViewLayout));
     ...
     *
     * @return CustomDialogColor
     */
    public
    @Nullable
    CustomDialogColor getmDialog() {
        if (mDialog == null)
            return null;
        return mDialog.get();
    }
