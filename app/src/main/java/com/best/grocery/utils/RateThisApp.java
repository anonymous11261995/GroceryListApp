...
public class RateThisApp implements DefinitionSchema {
    private static final String TAG = RateThisApp.class.getSimpleName();

    private static final String PREF_NAME = SHARE_PREFERENCES_PREF_NAME;
    private static final String KEY_INSTALL_DATE = SHARE_PREFERENCES_KEY_INSTALL_DATE;
    private static final String KEY_LAUNCH_TIMES = SHARE_PREFERENCES_KEY_LAUNCH_TIMES;
    private static final String KEY_OPT_OUT = SHARE_PREFERENCES_KEY_OPT_OUT;
    private static final String KEY_ASK_LATER_DATE = SHARE_PREFERENCES_KEY_ASK_LATER_DATE;
    ...
    public static void onCreate(Context context) {
        ...
        Log.d("rate_app", "diaolog_rate_app_showed:" + mOptOut);
    }
    ...
    public static boolean shouldShowRateDialog() {
        if (mOptOut) {
            ...
            Log.d("rate_app", "mLaunchTimes: " + mLaunchTimes + " mCriteriaLaunchTimes:" + sConfig.mCriteriaLaunchTimes + " ---install: " + mInstallDate + " time used: " + (new Date().getTime() - mInstallDate.getTime()) + " contidition: " + threshold);
            if (mLaunchTimes >= sConfig.mCriteriaLaunchTimes && new Date().getTime() - mInstallDate.getTime() >= threshold) {
                return true;
            }
            return false;
        }
    ...
    public static class Config {
        ...
        private int mCancelMode = CANCEL_MODE_BACK_KEY;
